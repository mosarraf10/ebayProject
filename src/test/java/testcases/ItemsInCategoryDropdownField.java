...
public class ItemsInCategoryDropdownField {
	
	public List<String>getItemsInCatDD(){
		
	List<String>itemsInCatDD = new ArrayList<String>();
	itemsInCatDD.addAll(Arrays.asList("All Departments", "Alexa Skills", "Amazon Devices", "Amazon Fresh",
			"Amazon Warehouse", "Appliances", "Apps & Games", "Arts, Crafts & Sewing",
